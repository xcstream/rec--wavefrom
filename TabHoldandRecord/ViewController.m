...
- (void)levelTimerCallback:(NSTimer *)timer {
    ...
    NSString *time = [NSString stringWithFormat:@"%2.0f:%2.0f",minutes, seconds];
    totalsec = audioRecorder.currentTime;
...
-(IBAction) stopRecording
{
    ...
    FDWaveformView* fw = [[FDWaveformView alloc] initWithFrame:CGRectMake(0, 30, 320, 100)];
    fw.audioURL = url;
//    fw.progressSamples = 10000;
    fw.tag  = 100;
...
-(IBAction) playRecording
{
    ...
    FDWaveformView* fw = (FDWaveformView* )[self.view viewWithTag:100];
    [UIView animateWithDuration:totalsec animations:^{
        fw.progressSamples = fw.totalSamples;
    }];
